        ...
        if method == 'kwconf_python':
            ...
            lines.extend(
                [
                    ...
                    '_backend_start = _clock()',
                    '_rust_bridge_start = _clock()',
                    'from kwconf import _rust as _rust_mod',
                    '_rust_bridge_end = _clock()',
                    '_extension_start = _clock()',
                    '_extension = _rust_mod._load_extension(required=True)',
                    '_extension_end = _clock()',
                    '_schema_start = _clock()',
                    '_specs, _metadata = _rust_mod._schema_description(_cfg)',
                    '_schema_end = _clock()',
                    '_parser_build_start = _clock()',
                    '_parser = _extension.FlatParser(_specs)',
                    '_compiled = _rust_mod._CompiledConfig(',
                    '    parser=_parser,',
                    '    keys=_metadata.keys,',
                    '    templates=_metadata.templates,',
                    '    mutex_groups=_metadata.mutex_groups,',
                    '    required_keys=_metadata.required_keys,',
                    ')',
                    '_rust_mod._class_cache_set(type(_cfg), _rust_mod._SCHEMA_CACHE_ATTR, _compiled)',
                    '_parser_build_end = _clock()',
                    '_backend_end = _clock()',
                    '_parse_start = _clock()',
                    '_parsed = _rust_mod.parse_compiled(_cfg, _compiled, _normalized_argv, strict=True)',
