...
Notes:
    ...
    rm -rf ~/code/kwconf/docs/source/auto
    cd ~/code/kwconf/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/kwconf/docs/source/auto ~/code/kwconf/kwconf
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/kwconf/advanced/
        ...
        For gitlab you also need to setup an integrations. Navigate to:
            ...
            https://readthedocs.org/dashboard/kwconf/integrations/create/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwconf/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'kwconf')
...
# html_logo = '.static/kwconf.svg'
# html_favicon = '.static/kwconf.ico'
...
man_pages = [(master_doc, 'kwconf', 'kwconf Documentation', [author], 1)]
